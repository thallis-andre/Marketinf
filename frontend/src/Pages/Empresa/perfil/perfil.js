        ...
        <div>
            ...
            <div className="editar-influencer">
                ...
                <Row>
                    ...
                    <Col >
                        <label htmlFor="nome" className="label-perfil">Nome da empresa:</label>
                        <input id="nome" type="text" className="input-perfil" autocomplete="off" />
                        <label htmlFor="nome" className="label-perfil mt-5">Cidade:</label>
                        <input id="nome" type="text" className="input-perfil" autocomplete="off" />
                        <label htmlFor="nome" className="label-perfil mt-5">Perfil profissional do instagram:</label>
                ...
                <Row className="input-group-perfil">
                    <Col className="margin-input-group">
                        <label htmlFor="nome" className="label-perfil">Website:</label>
                        <input id="nome" type="text" className="input-perfil" autocomplete="off" />
                        <label htmlFor="nome" className="label-perfil mt-5">Setor da loja:</label>
